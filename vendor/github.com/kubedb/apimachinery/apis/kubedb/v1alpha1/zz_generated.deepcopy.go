...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MongoDBClusterMode) DeepCopyInto(out *MongoDBClusterMode) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MongoDBClusterMode.
func (in *MongoDBClusterMode) DeepCopy() *MongoDBClusterMode {
	if in == nil {
		return nil
	}
	out := new(MongoDBClusterMode)
	in.DeepCopyInto(out)
	return out
}
